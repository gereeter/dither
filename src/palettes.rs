...
pub const REALLYSAFE: [Srgb8; 22] = [
    image::Rgb { data: [0x00,0x00,0x00] },
    image::Rgb { data: [0xFF,0x00,0x00] },
    image::Rgb { data: [0x00,0x00,0x33] },
    image::Rgb { data: [0xFF,0x00,0x33] },
    image::Rgb { data: [0x00,0x00,0xFF] },
    image::Rgb { data: [0xFF,0x00,0xFF] },
    image::Rgb { data: [0x00,0xFF,0x00] },
    image::Rgb { data: [0x66,0xFF,0x00] },
    image::Rgb { data: [0xFF,0xFF,0x00] },
    image::Rgb { data: [0x33,0xFF,0x33] },
    image::Rgb { data: [0x66,0xFF,0x33] },
    image::Rgb { data: [0xFF,0xFF,0x33] },
    image::Rgb { data: [0x00,0xFF,0x66] },
    image::Rgb { data: [0x33,0xFF,0x66] },
    image::Rgb { data: [0xCC,0xFF,0x66] },
    image::Rgb { data: [0xFF,0xFF,0x66] },
    image::Rgb { data: [0x00,0xFF,0xCC] },
    image::Rgb { data: [0x33,0xFF,0xCC] },
    image::Rgb { data: [0x00,0xFF,0xFF] },
    image::Rgb { data: [0x33,0xFF,0xFF] },
    image::Rgb { data: [0x66,0xFF,0xFF] },
    image::Rgb { data: [0xFF,0xFF,0xFF] },
];
...
pub const PETZ_SOURCE: [Srgb8; 256] = [
    ...
    image::Rgb { data: [0x00, 0x80, 0x80] },
    image::Rgb { data: [0xC0, 0xC0, 0xC0] },
    image::Rgb { data: [0xD4, 0xD0, 0xC8] },
    image::Rgb { data: [0x40, 0x80, 0x80] },
    image::Rgb { data: [0xE7, 0xE2, 0xDD] },
    image::Rgb { data: [0xE3, 0xDE, 0xD8] },
    image::Rgb { data: [0xDF, 0xDA, 0xD4] },
    image::Rgb { data: [0xDB, 0xD6, 0xD0] },
    image::Rgb { data: [0xD7, 0xD2, 0xCC] },
    image::Rgb { data: [0xD3, 0xCE, 0xC7] },
    image::Rgb { data: [0xCF, 0xCA, 0xC3] },
    image::Rgb { data: [0xCB, 0xC6, 0xBF] },
    image::Rgb { data: [0xC7, 0xC2, 0xBB] },
    image::Rgb { data: [0xC3, 0xBE, 0xB6] },
    image::Rgb { data: [0x75, 0x75, 0x75] },
    image::Rgb { data: [0x6F, 0x6F, 0x6F] },
    image::Rgb { data: [0x6A, 0x6A, 0x6A] },
    image::Rgb { data: [0x65, 0x65, 0x65] },
    image::Rgb { data: [0x60, 0x60, 0x60] },
    image::Rgb { data: [0x5B, 0x5B, 0x5B] },
    image::Rgb { data: [0x56, 0x56, 0x56] },
    image::Rgb { data: [0x51, 0x51, 0x51] },
    image::Rgb { data: [0x4C, 0x4C, 0x4C] },
    image::Rgb { data: [0x46, 0x46, 0x46] },
    image::Rgb { data: [0x42, 0x42, 0x42] },
    image::Rgb { data: [0x3A, 0x3A, 0x3A] },
    image::Rgb { data: [0x33, 0x33, 0x33] },
    image::Rgb { data: [0x2C, 0x2C, 0x2C] },
    image::Rgb { data: [0x24, 0x24, 0x24] },
    image::Rgb { data: [0x1D, 0x1D, 0x1D] },
    image::Rgb { data: [0x16, 0x16, 0x16] },
    image::Rgb { data: [0x0E, 0x0E, 0x0E] },
    image::Rgb { data: [0x07, 0x07, 0x07] },
    image::Rgb { data: [0x00, 0x00, 0x00] },
    image::Rgb { data: [0xDC, 0xC2, 0x96] },
    image::Rgb { data: [0xD5, 0xBB, 0x90] },
    image::Rgb { data: [0xCF, 0xB5, 0x8A] },
    image::Rgb { data: [0xCF, 0xB5, 0x8A] },
    image::Rgb { data: [0xC2, 0xA9, 0x7F] },
    image::Rgb { data: [0xBB, 0xA2, 0x7A] },
    image::Rgb { data: [0xB5, 0x9C, 0x74] },
    image::Rgb { data: [0xB5, 0x9C, 0x74] },
    image::Rgb { data: [0xA8, 0x90, 0x69] },
    image::Rgb { data: [0xA2, 0x89, 0x63] },
    image::Rgb { data: [0x87, 0x41, 0x22] },
    image::Rgb { data: [0x7F, 0x3D, 0x20] },
    image::Rgb { data: [0x77, 0x39, 0x1E] },
    image::Rgb { data: [0x70, 0x35, 0x1C] },
    image::Rgb { data: [0x68, 0x31, 0x1A] },
    image::Rgb { data: [0x61, 0x2D, 0x18] },
    image::Rgb { data: [0x59, 0x29, 0x16] },
    image::Rgb { data: [0x52, 0x25, 0x14] },
    image::Rgb { data: [0x4A, 0x21, 0x12] },
    image::Rgb { data: [0x42, 0x1D, 0x10] },
    image::Rgb { data: [0xB4, 0x73, 0x16] },
    image::Rgb { data: [0xAF, 0x6D, 0x13] },
    image::Rgb { data: [0xAA, 0x68, 0x11] },
    image::Rgb { data: [0xA5, 0x63, 0x0E] },
    image::Rgb { data: [0xA1, 0x5E, 0x0C] },
    image::Rgb { data: [0x9C, 0x58, 0x09] },
    image::Rgb { data: [0x97, 0x53, 0x07] },
    image::Rgb { data: [0x93, 0x4E, 0x04] },
    image::Rgb { data: [0x8E, 0x49, 0x02] },
    image::Rgb { data: [0x89, 0x44, 0x00] },
    image::Rgb { data: [0xF0, 0x9E, 0xB7] },
    image::Rgb { data: [0xE9, 0x99, 0xB2] },
    image::Rgb { data: [0xE3, 0x95, 0xAD] },
    image::Rgb { data: [0xDD, 0x91, 0xA8] },
    image::Rgb { data: [0xD6, 0x8D, 0xA3] },
    image::Rgb { data: [0xD0, 0x88, 0x9E] },
    image::Rgb { data: [0xCA, 0x84, 0x99] },
    image::Rgb { data: [0xC3, 0x80, 0x94] },
    image::Rgb { data: [0xBD, 0x7C, 0x8F] },
    image::Rgb { data: [0xB7, 0x77, 0x8B] },
    image::Rgb { data: [0xA8, 0x29, 0x01] },
    image::Rgb { data: [0xA4, 0x28, 0x01] },
    image::Rgb { data: [0x9F, 0x27, 0x01] },
    image::Rgb { data: [0x9B, 0x26, 0x01] },
    image::Rgb { data: [0x97, 0x25, 0x01] },
    image::Rgb { data: [0x92, 0x24, 0x01] },
    image::Rgb { data: [0x8E, 0x23, 0x01] },
    image::Rgb { data: [0x8A, 0x22, 0x01] },
    image::Rgb { data: [0x85, 0x21, 0x01] },
    image::Rgb { data: [0x81, 0x20, 0x01] },
    image::Rgb { data: [0x6B, 0x4A, 0x0C] },
    image::Rgb { data: [0x65, 0x44, 0x0B] },
    image::Rgb { data: [0x60, 0x3E, 0x0B] },
    image::Rgb { data: [0x5B, 0x39, 0x0B] },
    image::Rgb { data: [0x56, 0x33, 0x0B] },
    image::Rgb { data: [0x51, 0x2D, 0x0A] },
    image::Rgb { data: [0x4C, 0x27, 0x0A] },
    image::Rgb { data: [0x47, 0x22, 0x0A] },
    image::Rgb { data: [0x42, 0x1C, 0x0A] },
    image::Rgb { data: [0x3C, 0x16, 0x09] },
    image::Rgb { data: [0xA6, 0x8A, 0x38] },
    image::Rgb { data: [0xA2, 0x85, 0x37] },
    image::Rgb { data: [0x9E, 0x81, 0x37] },
    image::Rgb { data: [0x9A, 0x7D, 0x37] },
    image::Rgb { data: [0x96, 0x78, 0x36] },
    image::Rgb { data: [0x93, 0x74, 0x36] },
    image::Rgb { data: [0x8F, 0x70, 0x36] },
    image::Rgb { data: [0x8B, 0x6B, 0x35] },
    image::Rgb { data: [0x87, 0x67, 0x35] },
    image::Rgb { data: [0x84, 0x62, 0x35] },
    image::Rgb { data: [0x62, 0x70, 0x7D] },
    image::Rgb { data: [0x5D, 0x69, 0x76] },
    image::Rgb { data: [0x58, 0x63, 0x70] },
    image::Rgb { data: [0x53, 0x5D, 0x69] },
    image::Rgb { data: [0x4E, 0x57, 0x63] },
    image::Rgb { data: [0x49, 0x50, 0x5D] },
    image::Rgb { data: [0x44, 0x4A, 0x56] },
    image::Rgb { data: [0x3F, 0x44, 0x50] },
    image::Rgb { data: [0x3A, 0x3E, 0x4A] },
    image::Rgb { data: [0x36, 0x38, 0x43] },
    image::Rgb { data: [0x9A, 0x8E, 0x73] },
    image::Rgb { data: [0x96, 0x8A, 0x70] },
    image::Rgb { data: [0x93, 0x87, 0x6D] },
    image::Rgb { data: [0x90, 0x84, 0x6B] },
    image::Rgb { data: [0x8C, 0x81, 0x68] },
    image::Rgb { data: [0x89, 0x7E, 0x66] },
    image::Rgb { data: [0x86, 0x7B, 0x63] },
    image::Rgb { data: [0x82, 0x78, 0x61] },
    image::Rgb { data: [0x7F, 0x75, 0x5E] },
    image::Rgb { data: [0x7C, 0x71, 0x5B] },
    image::Rgb { data: [0x55, 0xAB, 0x57] },
    image::Rgb { data: [0x3C, 0xA1, 0x47] },
    image::Rgb { data: [0x15, 0x99, 0x17] },
    image::Rgb { data: [0x35, 0x83, 0x36] },
    image::Rgb { data: [0x30, 0x7B, 0x1C] },
    image::Rgb { data: [0x10, 0x79, 0x19] },
    image::Rgb { data: [0x27, 0x62, 0x17] },
    image::Rgb { data: [0x2F, 0x5E, 0x2B] },
    image::Rgb { data: [0x13, 0x5C, 0x14] },
    image::Rgb { data: [0x10, 0x41, 0x11] },
    image::Rgb { data: [0x2B, 0x61, 0xC3] },
    image::Rgb { data: [0x38, 0x46, 0xE3] },
    image::Rgb { data: [0x33, 0x3B, 0xFF] },
    image::Rgb { data: [0x33, 0x43, 0xCE] },
    image::Rgb { data: [0x16, 0x1A, 0xD7] },
    image::Rgb { data: [0x2E, 0x3C, 0xB6] },
    image::Rgb { data: [0x16, 0x1C, 0xA9] },
    image::Rgb { data: [0x2A, 0x42, 0x90] },
    image::Rgb { data: [0x19, 0x22, 0x77] },
    image::Rgb { data: [0x11, 0x19, 0x53] },
    image::Rgb { data: [0xD8, 0xF0, 0xFF] },
    image::Rgb { data: [0xAC, 0xE0, 0xFF] },
    image::Rgb { data: [0x99, 0xD6, 0xFF] },
    image::Rgb { data: [0x82, 0xCA, 0xFF] },
    image::Rgb { data: [0x75, 0xB6, 0xE8] },
    image::Rgb { data: [0x68, 0xC0, 0xFF] },
    image::Rgb { data: [0x51, 0x96, 0xDC] },
    image::Rgb { data: [0x18, 0x9C, 0xCE] },
    image::Rgb { data: [0x56, 0x8B, 0xB9] },
    image::Rgb { data: [0x1E, 0x89, 0xA9] },
    image::Rgb { data: [0xEB, 0xED, 0xA7] },
    image::Rgb { data: [0xEA, 0xEB, 0x90] },
    image::Rgb { data: [0xD1, 0xCC, 0x77] },
    image::Rgb { data: [0xF7, 0xF4, 0x00] },
    image::Rgb { data: [0xED, 0xE8, 0x32] },
    image::Rgb { data: [0xC3, 0xC4, 0x0B] },
    image::Rgb { data: [0xC3, 0xC3, 0x34] },
    image::Rgb { data: [0x9F, 0xA2, 0x17] },
    image::Rgb { data: [0x9F, 0x9F, 0x43] },
    image::Rgb { data: [0x6E, 0x7A, 0x2E] },
    image::Rgb { data: [0xFF, 0xFF, 0xFF] },
    image::Rgb { data: [0xC0, 0xE4, 0xE7] },
    image::Rgb { data: [0xAC, 0xC6, 0xD5] },
    image::Rgb { data: [0xA7, 0xA7, 0xB1] },
    image::Rgb { data: [0xA0, 0xA0, 0xA8] },
    image::Rgb { data: [0x74, 0xA0, 0xB6] },
    image::Rgb { data: [0x83, 0x99, 0xB1] },
    image::Rgb { data: [0x83, 0x99, 0xB1] },
    image::Rgb { data: [0x80, 0x98, 0xB0] },
    image::Rgb { data: [0x80, 0x98, 0xB0] },
    image::Rgb { data: [0xE2, 0xBE, 0xAC] },
    image::Rgb { data: [0xD5, 0x93, 0x90] },
    image::Rgb { data: [0xD7, 0x76, 0x6E] },
    image::Rgb { data: [0xB8, 0x73, 0x67] },
    image::Rgb { data: [0x9F, 0x77, 0x73] },
    image::Rgb { data: [0xA2, 0x6A, 0x5D] },
    image::Rgb { data: [0x89, 0x64, 0x58] },
    image::Rgb { data: [0x98, 0x57, 0x4D] },
    image::Rgb { data: [0x6A, 0x45, 0x42] },
    image::Rgb { data: [0x5A, 0x3C, 0x31] },
    image::Rgb { data: [0x72, 0x9E, 0x8C] },
    image::Rgb { data: [0x00, 0x80, 0x80] },
    image::Rgb { data: [0x42, 0x7A, 0x75] },
    image::Rgb { data: [0x00, 0x80, 0x80] },
    image::Rgb { data: [0x39, 0x78, 0x60] },
    image::Rgb { data: [0x3D, 0x5A, 0x63] },
    image::Rgb { data: [0x26, 0x58, 0x47] },
    image::Rgb { data: [0x21, 0x41, 0x2B] },
    image::Rgb { data: [0x12, 0x39, 0x30] },
    image::Rgb { data: [0xFF, 0xFF, 0xFF] },
    image::Rgb { data: [0xFF, 0xFF, 0xFF] },
    image::Rgb { data: [0xF4, 0xF6, 0xD8] },
    image::Rgb { data: [0xE9, 0xD8, 0xC2] },
    image::Rgb { data: [0x2C, 0x5F, 0x59] },
    image::Rgb { data: [0xD3, 0xF4, 0xC5] },
    image::Rgb { data: [0xC4, 0xD3, 0x9F] },
    image::Rgb { data: [0xFF, 0xC7, 0x1A] },
    image::Rgb { data: [0xB0, 0xB8, 0x9B] },
    image::Rgb { data: [0xAF, 0xB1, 0x77] },
    image::Rgb { data: [0xA5, 0x94, 0x8E] },
    image::Rgb { data: [0xAC, 0xA9, 0x8F] },
    image::Rgb { data: [0xD7, 0xA0, 0x14] },
    image::Rgb { data: [0xC6, 0x7F, 0x08] },
    image::Rgb { data: [0xCA, 0x6E, 0x46] },
    image::Rgb { data: [0x79, 0x8E, 0x61] },
    image::Rgb { data: [0x99, 0x7E, 0x4D] },
    image::Rgb { data: [0x80, 0x80, 0x80] },
    image::Rgb { data: [0x65, 0x9B, 0x2A] },
    image::Rgb { data: [0x00, 0xCB, 0x16] },
    image::Rgb { data: [0xA7, 0x6C, 0x39] },
    image::Rgb { data: [0xFF, 0x42, 0x00] },
    image::Rgb { data: [0x97, 0x64, 0x42] },
    image::Rgb { data: [0x99, 0x65, 0x2A] },
    image::Rgb { data: [0xDD, 0x34, 0x6A] },
    image::Rgb { data: [0x29, 0x44, 0x75] },
    image::Rgb { data: [0x58, 0x69, 0xB5] },
    image::Rgb { data: [0x42, 0x6B, 0x84] },
    image::Rgb { data: [0x50, 0x64, 0x80] },
    image::Rgb { data: [0x75, 0x59, 0x4A] },
    image::Rgb { data: [0x0A, 0x24, 0x6A] },
    image::Rgb { data: [0x80, 0x80, 0x80] },
    image::Rgb { data: [0xD4, 0xD0, 0xC8] },
    image::Rgb { data: [0xFF, 0xFF, 0xFF] },
    image::Rgb { data: [0x00, 0x00, 0x00] },
